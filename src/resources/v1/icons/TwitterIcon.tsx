...
type TwitterIconVariant = 'circle'

interface Props {
    size?: number,
    logoColor?: string,
    circleColor?: string,
    variant?: TwitterIconVariant
}
    ...
    return (
        {
            ...
            logoColor: pickOrDefault(props.logoColor, 'black'),
...
const TwitterIcon: React.FC<Props> = (receivedProps) => {
    ...
    if (props.variant == "circle") {
        return (
            ...
            >
                <TwitterIcon {...props} variant={undefined} />
            </View>
        )
    }
